...
public class Pemilihandokter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.getAccessibleContext().setAccessibleName("Identitas");
        usia.getAccessibleContext().setAccessibleName("Identitas");
        jenis.getAccessibleContext().setAccessibleName("Identitas");
        jLabel4.getAccessibleContext().setAccessibleName("Identitas");
        gol.getAccessibleContext().setAccessibleName("Identitas");
        jLabel5.getAccessibleContext().setAccessibleName("Identitas");
        status.getAccessibleContext().setAccessibleName("Identitas");
        jLabel6.getAccessibleContext().setAccessibleName("Identitas");
        kewar.getAccessibleContext().setAccessibleName("Identitas");
        jLabel7.getAccessibleContext().setAccessibleName("Identitas");
        spesial.getAccessibleContext().setAccessibleName("Identitas");
        jLabel8.getAccessibleContext().setAccessibleName("Identitas");
        jLabel9.getAccessibleContext().setAccessibleName("Identitas");
        jLabel10.getAccessibleContext().setAccessibleName("Identitas");
        nama.getAccessibleContext().setAccessibleName("Identitas");
        alamat.getAccessibleContext().setAccessibleName("Identitas");
        ...
        getAccessibleContext().setAccessibleName("Identitas");
